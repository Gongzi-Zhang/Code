...
\usepackage{siunitx}	% provide commands for various SI units
\usepackage{bm}	% bold math
\usepackage[first=0, last=9]{lcg}   % pseudo random number generator
...
\usepackage[table, dvipsnames]{xcolor}   % colored text
\usepackage{tikz}
...
\usepackage{adjustbox}	% extend table width
...
\end{itemize}
\include{hello_world/Introduction}
\include{hello_world/Basic}
\include{hello_world/Math}
\include{hello_world/Tikz}
\include{hello_world/Customization}
\include{hello_world/Advanced}
\include{hello_world/Metaphysics}
\include{hello_world/Bibliography}
% \input{}
