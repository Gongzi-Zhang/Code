...
\section{Columns}
\begin{multicols}{2}
[To make multi columns environment, include the package \package{multicol}, and use the command \textbackslash{}begin\{multicols\}\{N\}, where N is the number of columns.]
