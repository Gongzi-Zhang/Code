...
A \command{\textbackslash{}parbox} is a box of specific width formatted in paragraph mode. 
In paragraph mode, text is broken into lines and lines are broken into pages.
\command{\textbackslash{}parbox[pos][height][contentpos]\{width\}\{text\}}
...
\command{\textbackslash{}pbox[pos][height]\{width\}\{text\}}
